...
def main():
    ...
    parser_record.add_argument('-ie', '--include_events', action='append', dest='include_events', help='需要记录事件 (default: [])')
    ...
    parser_record.add_argument('-ar', '--auto_release', action='store_true', dest='auto_release', help='自动释放按键 (default: true)')
